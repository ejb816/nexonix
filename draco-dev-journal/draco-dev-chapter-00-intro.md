...
**Status at Chapter 72 (session possibly ongoing):** the drake parser is real — increment 1 (plain types, recursive descent inverting the emitter) landed at 478/478 and commit `70d94a8`; increment 2 (rule and actor aspects, #53 closed) at 495/495 and `01b3aad`, with the family-wide `name`/`valueType` defaults strip behind it; the loss tail is fully accounted (78 = #54 + #61 + #55); next pickup is #54, with #58 unblocked and #51 still frozen.
