...
object Draco extends App with DracoType {
  ...
  lazy val elementTypeNames: Seq[String] = Seq ("Action", "Actor", "ActorAspect", "ActorType", "Aspects", "Assembly", "Binding", "BodyElement", "CLI", "Case", "CodecAspect", "CollectProblems", "Completeness", "Condition", "ContentSink", "DerivationResolvable", "Dictionary", "Domain", "DomainAspect", "DomainDictionary", "DomainTransform", "DomainType", "DracoAspect", "DracoType", "Dynamic", "Factory", "Fixed", "Generator", "Holon", "Main", "Monadic", "Mutable", "Parameter", "Pattern", "Primal", "Problem", "REPL", "Rule", "RuleAspect", "RuleType", "SelfDeclaration", "Source", "SourceContent", "Target", "Test", "Type", "TypeDefinition", "TypeDictionary", "TypeElement", "TypeLoader", "TypeName", "TypeTransform", "Variable")
