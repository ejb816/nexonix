 ...
 */
  ...
  */
  test("Test Stooge Actor Hierarchy") {
    ...
    actorSystem ! AddStooge("Moe")
    actorSystem ! AddStooge("Larry")
    actorSystem ! AddStooge("Curly")
    Thread.sleep(1000)
    actorSystem ! InitializeStoogeReaction("Moe", "Moe")
    Thread.sleep(1000)
    actorSystem ! InitializeStoogeReaction("Larry", "Larry")
    Thread.sleep(1000)
    actorSystem ! InitializeStoogeReaction("Curly", "Curly")
    Thread.sleep(1000)
    actorSystem ! ActOnStooge("Moe", StoogeAction.Start)
    Thread.sleep(1000)
    actorSystem ! ActOnStooge("Larry", StoogeAction.Bonk)
    Thread.sleep(1000)
    actorSystem ! ActOnStooge("Curly", StoogeAction.Bonk)
    Thread.sleep(1000)
    actorSystem ! ActOnStooge("Moe",StoogeAction.Poke)
    Thread.sleep(1000)
    actorSystem ! ActOnStooge("Larry",StoogeAction.Poke)
    Thread.sleep(1000)
    actorSystem ! ActOnStooge("Curly",StoogeAction.Poke)
    Thread.sleep(1000)
    actorSystem ! ActOnStooge("Moe",StoogeAction.Slap)
    Thread.sleep(1000)
    actorSystem ! ActOnStooge("Larry",StoogeAction.Slap)
    Thread.sleep(1000)
    actorSystem ! ActOnStooge("Curly",StoogeAction.Slap)
    Thread.sleep(1000)
    actorSystem ! ActOnStooge("Moe",StoogeAction.Stop)
    Thread.sleep(1000)
    actorSystem ! ActOnStooge("Larry",StoogeAction.Stop)
    Thread.sleep(1000)
    actorSystem ! ActOnStooge("Curly",StoogeAction.Stop)
    Thread.sleep(1000)
