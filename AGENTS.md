...
A symlink `AGENTS.md → DRACO.md` ensures Codex auto-loads this file.
...
- **CHANGELOG.md** — History of changes made with Codex assistance
- **Auto-memory** — Persistent project memory at `~/.Codex/projects/.../memory/MEMORY.md` with architectural decisions, lazy val rules, Generator naming conventions, and imminent task list
